...
const EXAMPLE_FIRST_NODE: Node = {
  ...
  name: "Science",
  description:
    "Science is a systematic process that builds and organizes knowledge in the form of testable explanations and predictions about the universe.",
};
...
const functions: ChatCompletionCreateParams.Function[] = [
  {
    ...
    description:
      "List 5-10 subconcepts and their descriptions, given a concept",
    parameters: {
      type: "object",
      properties: {
        subconcepts: {
  ...
  try {
    ...
    while (nodes.length < TEST_STOP_LENGTH && interim_nodes.length > 0) {
      ...
      if (
        ...
        message.function_call?.name === "list_subconcepts"
      ) {
...
export default function KnowledgeTree() {
  ...
  return (
    <div
      className="stretch mx-auto flex w-full flex-col py-24"
      style={{ maxWidth: "100vw", textAlign: "center" }}
    >
      <h1>Knowledge Tree</h1>
      <p>Works best for academic concepts!</p>
      <div style={{ display: "inline-block", textAlign: "center" }}>
        ...
        >
          <input
            ...
            name="name"
            value={firstNode}
            placeholder="Your starting concept"
          ...
          <button
            type="submit"
            className="my-4 rounded-lg border border-black bg-black px-4 py-1.5 text-sm font-medium text-white transition-all hover:bg-white hover:text-black active:bg-stone-100 dark:border-stone-700 dark:hover:border-stone-200 dark:hover:bg-black dark:hover:text-white dark:active:bg-stone-800"
          >
